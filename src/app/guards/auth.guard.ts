import { Init } from './../modules/authorization/store/actions';
...
export class AuthGuard implements CanActivate, CanActivateChild {
	...
	constructor(private router: Router, private auth: AngularFireAuth, private ngZone: NgZone, private store: Store) {
